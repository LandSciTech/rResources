...
* Avoid repetition. Use [functions](https://r4ds.had.co.nz/functions.html) and [loops or iteration functions (eg `apply`, `purrr::map`)](https://r4ds.had.co.nz/iteration.html)
